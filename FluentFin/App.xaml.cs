...
public partial class App : Application
{
	...
	public App()
	{
		...
		.ConfigureServices((context, services) =>
		{
			...
			services.AddSingleton<WindowsVideoPlaybackEngine>();
			services.AddSingleton<FlyleafPlaybackEngine>();
			services.AddSingleton<VlcPlaybackEngine>();
			services.AddSingleton<MpvTrackMapper>();
			services.AddSingleton<MpvPlaybackEngine>();
			services.AddSingleton<VideoPlaybackController>();
			services.AddSingleton<IVideoPlaybackController>(sp => sp.GetRequiredService<VideoPlaybackController>());
			services.AddSingleton<IPlaybackController>(sp => sp.GetRequiredService<VideoPlaybackController>());
			...
			services.AddTransient<MusicPlaylistViewModel>();
